...
class Config:
    # Email Configuration - Use SendGrid for production, Gmail for development
    if os.getenv('SENDGRID_API_KEY'):
        ...
        MAIL_DEFAULT_SENDER = os.getenv('SENDGRID_FROM_EMAIL', 'fawnahotel@gmail.com')
    else:
        ...
        MAIL_DEFAULT_SENDER = os.getenv('MAIL_USERNAME') or os.getenv('SMTP_USERNAME')
